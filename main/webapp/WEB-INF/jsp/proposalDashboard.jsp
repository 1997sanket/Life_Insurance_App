...
<body>
		...
		Proposal ID	:	<strong> ${requestScope.proposal.id}</strong> <br> <br>
		...
		<a href="http://localhost:8080/acceptProposal"> Accept</a> <br> <br>
		<a href="http://localhost:8080/rejectProposal"> Reject </a> <br> <br>
